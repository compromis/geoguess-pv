export default {
  ...
  es: {
    label: 'Pedralba',
    question: '¿Dónde están estas casas?',
    answer: 'Estamos en el municipio de Pedralba',
    text: `
      <p>
        Nos encontramos en el municipio de <strong>Pedralba</strong>, localidad que necesita con urgencia
      ...
      <p>
        Después todos los partidos quieren hablar de emergencia climática y sostenibilidad.
        Todo al más puro estilo greenwashing.
      </p>
    `
  },
  position: {
